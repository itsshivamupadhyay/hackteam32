...
class mygrid(GridLayout):
    def __init__(self,**kwargs):
        ...
        self.fileselect = Button(text = "select file", font_size = 30)
        self.add_widget(self.fileselect)
    ...
    def dec(self, event):
        passcode = input("enter your code: ")
        return pyAesCrypt.decryptFile("C:\\Users\Shivam Upadhyay\Desktop\hellp.txt.aes","C:\\Users\Shivam Upadhyay\Desktop\h.txt",passcode,buffersize)
